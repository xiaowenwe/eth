...
// blocks. Suitable for both light and full clients.// Oracle根据最近块的内容推荐汽油价格。 适合轻型客户和全客户。
type Oracle struct {
...
// getBlockPrices计算给定块中的最低事务气体价格并将其发送到结果通道。 如果该块为空，则价格为零。
