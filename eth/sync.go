...
// 还记得Start()启动的四个函数么? 其中第四项txsyncLoop()中用以等待txsync{}数据的通道txsyncCh，正是在这里被推入txsync{}的
...
func (pm *ProtocolManager) synchronise(peer *peer) {
	...
	if head := pm.blockchain.CurrentBlock(); head.NumberU64() > 0 {
		...
		go pm.BroadcastBlock(head, false) // 我们告诉所有的peer我们的状态。
	}
}
