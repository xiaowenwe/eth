...
//包bn256在128位安全级别实现特定的双线性组。
//
//双线性组是许多新加密协议的基础
//在过去十年中提出的建议。 它们由三重组成
//组（G 1，G 2和GT）使得存在函数e（g 1，g 2）=gTˣʸ
//（其中gₓ是相应组的生成器）。 该函数被调用
//配对功能
//
//这个包专门实现了256位的Optimal Ate配对
// Barreto-Naehrig曲线如描述
// http://cryptojedi.org/papers/dclxvi-20100714.pdf。 它的输出兼容
//使用该论文中描述的实现。
