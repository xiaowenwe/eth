...
// GetBodyRLP retrieves the block body (transactions and uncles) in RLP encoding.GetBodyRLP以RLP编码检索块体（事务和叔叔）。
...
// hash.// GetBody检索与哈希对应的块体（transactons，uncles）。
...
func GetBlock(ctx context.Context, odr OdrBackend, hash common.Hash, number uint64) (*types.Block, error) {
	...
	// Reassemble the block and return 重新组装块并返回
