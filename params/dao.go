...
///DAOForkBlockExtra是为DAO叉/Point设置的块头额外数据字段，以及多个连续块，以允许快速/轻型同步器正确/选择他们想要的侧(“道-硬-叉”)。
// DAOForkBlockExtra is the block header extra-data field to set for the DAO fork
// point and a number of consecutive blocks to allow fast/light syncers to correctly
// pick the side they want  ("dao-hard-fork").
var DAOForkBlockExtra = common.FromHex("0x64616f2d686172642d666f726b")

// DAOForkExtraRange是来自DAO fork point的连续块的数量，用于覆盖额外数据以防止无叉攻击。
// DAOForkExtraRange is the number of consecutive blocks from the DAO fork point
// to override the extra-data in to prevent no-fork attacks.
var DAOForkExtraRange = big.NewInt(10)

//DAORefundContraction是要将DAO余额发送到的退款合同的地址。
// DAORefundContract is the address of the refund contract to send DAO balances to.
var DAORefundContract = common.HexToAddress("0xbf4ed7b27f1d666546e30d74d50d173d20bca754")

///DAODRainList是帐户列表，其全部余额将在道-叉块开始时移动到/退款合同中。
