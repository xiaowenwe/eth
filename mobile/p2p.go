...
// NodeInfo represents pi short summary of the information known about the host.NodeInfo表示已知主机信息的pi简短摘要
...
// PeerInfos represents a slice of infos about remote peers.// PeerInfos代表一些关于远程对等体的信息
