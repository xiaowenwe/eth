...
// SetResolver是绑定合同方法0x1896f70a的付费mutator事务。
// Solidity：function setResolver（node bytes32，resolver address）返回（）
// SetResolver is a paid mutator transaction binding the contract method 0x1896f70a.
//
// Solidity: function setResolver(node bytes32, resolver address) returns()
...
type ENSNewOwnerIterator struct {
	Event *ENSNewOwner // Event containing the contract specifics and raw log包含合同细节和原始日志的事件
...
// FilterNewOwner是绑定合同事件0xce0457fe73731f824cc272376169235128c118b49d344817417c6d108d155e82的免费日志检索操作。
//
// Solidity：事件NewOwner（节点索引bytes32，标签索引bytes32，所有者地址）
...
// WatchNewOwner是一个绑定合同事件0xce0457fe73731f824cc272376169235128c118b49d344817417c6d108d155e82的免费日志订阅操作。
//
// Solidity：事件NewOwner（节点索引bytes32，标签索引bytes32，所有者地址）
...
// WatchTransfer是一个绑定合同事件0xd4735d920b0f87494915f556dd9b54c8f309026070caea5c737245152564d266的免费日志订阅操作。
//
// Solidity：event Transfer（节点索引bytes32，所有者地址）
